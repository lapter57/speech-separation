...
dr.download_data("../data/csv/avspeech_train.csv", 0, 10, "data/audio/speakers_train", "data/frames", 3.0, wait_tasks=False)
dr.download_data("../data/csv/avspeech_test.csv", 0, 10, "data/audio/speakers_test", "data/frames", 3.0, wait_tasks=False)
