...
ad.download_audio("../data/csv/avspeech_train.csv", "../data/audio/speakers_train", 0, 1000, 3.0)
ad.download_audio("../data/csv/avspeech_test.csv", "../data/audio/speakers_test", 0, 500, 3.0)
ad.download_audio("../data/csv/noise.csv", "../data/audio/noise", 0, 500, 3.0)
